		...
		{#if data.kind === 'errata'}
			{#each errata as e (e.id)}
				<div class="panel item">
					...
					{/if}
					<p class="pre"><RbText text={e.newText} keywords={false} /></p>
				</div>
			{/each}
		...
		{#if interactions}
			{#each interactions.items as i (i.id)}
				<div class="panel item">
					...
					<p class="pre"><RbText text={i.explanation} keywords={false} /></p>
				</div>
			{/each}
		{/if}
			...
			{#each corrections as c (c.id)}
				<div class="panel item corr">
					<div class="corr-body">
						...
						<p class="pre"><RbText text={c.text} keywords={false} /></p>
			...
			{#each knowledge as k (k.id)}
				<div class="panel item">
					...
					{:else}
						...
						{#if k.bodyNl}
							<p class="pre"><RbText text={k.bodyNl} keywords={false} /></p>
						...
						{/if}
						<p class="pre"><RbText text={k.body} keywords={false} /></p>
			...
			{#each claims.items as c (c.id)}
				<div class="panel item corr">
					<div class="corr-body">
						...
						<p class="pre"><RbText text={c.statement} keywords={false} /></p>
						{#if c.statusReason}<p class="meta refs">{c.statusReason}</p>{/if}
			...
			{#each relations.items as r (r.id)}
				<div class="panel item corr">
					<div class="corr-body">
						...
						<p class="pre"><RbText text={r.explanation} keywords={false} /></p>
