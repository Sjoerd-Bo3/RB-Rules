...
namespace RbRules.Infrastructure.Migrations
{
    ...
    [Migration("20260906180636_EvalCases387")]
    partial class EvalCases387
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RbRules.Domain.AiTariff", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<decimal>("InputUsdPerMTok")
                        .HasColumnType("numeric")
                        .HasColumnName("input_usd_per_m_tok");
                    ...
                    b.Property<decimal>("OutputUsdPerMTok")
                        .HasColumnType("numeric")
                        .HasColumnName("output_usd_per_m_tok");

                    b.HasKey("Id")
                        .HasName("pk_ai_tariff");

                    b.HasIndex("Model", "EffectiveFrom")
                        .HasDatabaseName("ix_ai_tariff_model_effective_from");

                    b.ToTable("ai_tariff", (string)null);
                });

            modelBuilder.Entity("RbRules.Domain.AiUsageEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ai_usage_event");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_ai_usage_event_created_at");
            ...
            modelBuilder.Entity("RbRules.Domain.CanonicalEntity", b =>
                {
                    ...
                    b.HasIndex("InteractionsMinedAt")
                        .HasDatabaseName("ix_canonical_entity_interactions_mined_at");
            ...
            modelBuilder.Entity("RbRules.Domain.Card", b =>
                {
                    ...
                    b.Property<string>("EffectPlain")
                        .HasColumnType("text")
                        .HasColumnName("effect_plain");
                    ...
                    b.Property<int?>("EmbeddingTruncatedAt")
                        .HasColumnType("integer")
                        .HasColumnName("embedding_truncated_at");
                    ...
                    b.Property<string>("ImageColorPrimary")
                        .HasColumnType("text")
                        .HasColumnName("image_color_primary");

                    b.Property<string>("ImageColorSecondary")
                        .HasColumnType("text")
                        .HasColumnName("image_color_secondary");
                    ...
                    b.Property<int?>("MightBonus")
                        .HasColumnType("integer")
                        .HasColumnName("might_bonus");
            ...
            modelBuilder.Entity("RbRules.Domain.Correction", b =>
                {
                    ...
                    b.HasIndex("Embedding")
                        .HasDatabaseName("ix_correction_embedding");
            ...
            modelBuilder.Entity("RbRules.Domain.EvalCaseRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(96)
                    ...
                    b.Property<string>("ExpectedCitationsJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("expected_citations_json");

                    b.Property<string>("ForbiddenClaimsJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("forbidden_claims_json");

                    b.Property<string>("GoldSupportJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("gold_support_json");
                    ...
                    b.Property<string>("SupersededByErratum")
                        .HasColumnType("text")
                        .HasColumnName("superseded_by_erratum");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_eval_case");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_eval_case_status");

                    b.ToTable("eval_case", (string)null);
                });
            ...
            modelBuilder.Entity("RbRules.Domain.Interaction", b =>
                {
                    ...
                    b.Property<int?>("ExtractBatchPosition")
                        .HasColumnType("integer")
                        .HasColumnName("extract_batch_position");

                    b.Property<string>("ExtractModel")
                        .HasColumnType("text")
                        .HasColumnName("extract_model");
            ...
            modelBuilder.Entity("RbRules.Domain.InteractionAudit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("InteractionStatusAtAudit")
                        .HasColumnType("text")
                        .HasColumnName("interaction_status_at_audit");
                    ...
                    b.Property<bool>("SupportedByEvidence")
                        .HasColumnType("boolean")
                        .HasColumnName("supported_by_evidence");

                    b.HasKey("Id")
                        .HasName("pk_interaction_audit");

                    b.HasIndex("AuditedAt")
                        .HasDatabaseName("ix_interaction_audit_audited_at");

                    b.HasIndex("InteractionId", "PromptVersion")
                        .HasDatabaseName("ix_interaction_audit_interaction_id_prompt_version");

                    b.ToTable("interaction_audit", (string)null);
                });
            ...
            modelBuilder.Entity("RbRules.Domain.KnowledgeDoc", b =>
                {
                    ...
                    b.HasIndex("Embedding")
                        .HasDatabaseName("ix_knowledge_doc_embedding");
