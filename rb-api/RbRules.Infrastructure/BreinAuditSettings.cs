...
public sealed record BreinAuditSettings(int SampleDivisor)
{
    ...
    public static readonly BreinAuditSettings Default = new(10);
    ...
    public BreinAuditSettings WithOverrides(IReadOnlyDictionary<string, string> overrides) =>
        overrides.TryGetValue(SettingKeys.BreinAuditSampleN, out var raw)
